...
class CryptocurrencySerializer(serializers.ModelSerializer):
    ...
    @staticmethod
    def _calculate_average_price(average_price_before, current_price, coin_amount_before, coin_amount_to_add):
        """Return average price for coin if user added it before."""
        return round((coin_amount_before * average_price_before + coin_amount_to_add * current_price), 2) / \
